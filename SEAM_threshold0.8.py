...
if __name__ == "__main__":
    ...
    process_unlabeled_images(model, "oxford-iiit-pet/images", "pseudo_mask_thr08", device, threshold=0.8)
    process_remaining_missing_masks(model, "oxford-iiit-pet/images", "pseudo_mask_thr08", device, threshold=0.8)
