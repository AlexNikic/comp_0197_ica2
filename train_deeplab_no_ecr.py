...
# ============================
# Equivariant Regularisation Loss
# ============================
def compute_equivariant_loss(pred, trans_pred):
    return nn.functional.mse_loss(pred, trans_pred)
    ...
    for epoch in range(1, 6):
        ...
        for images, masks in train_loader:
           ...
           # Applying transformations for equivariant regularisation
            ...
            # Computing equivariant regularisation loss
            equiv_loss = compute_equivariant_loss(outputs, trans_outputs)

             # Combining losses
            total_loss = loss + 0.1 * equiv_loss  
